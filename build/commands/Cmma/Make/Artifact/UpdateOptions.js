...
class UpdateOptions extends BaseCmmaArtifactCommand_1.BaseCmmaArtifactCommand {
    constructor() {
        super(...arguments);
        this.PROJECT_CONFIG = this.projectConfigurationFromFile;
        this.commandShortCode = 'mk|tyU';
        this.targetEntity = 'Update Options';
        this.artifactType = 'update-options';
    ...
    async run() {
        ...
        this.logger.info(`Found ${this.colors.underline(this.artifactLabel)} Model in ${this.colors.underline(modelSystemPath.systemLabel)} System of ${this.colors.underline(modelSystemPath.contextLabel)}`);
...
UpdateOptions.commandName = 'cmma:make-update-options';
UpdateOptions.description = 'Create a new CMMA Update Record TypeChecking';
UpdateOptions.settings = {
    loadApp: false,
    stayAlive: false,
};
__decorate([
    standalone_1.args.string({ description: 'Name of the Model this Update TypeChecking is for' }),
    __metadata("design:type", String)
], UpdateOptions.prototype, "name", void 0);
