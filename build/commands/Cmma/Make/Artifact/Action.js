...
class Action extends BaseCmmaArtifactCommand_1.BaseCmmaArtifactCommand {
    constructor() {
        super(...arguments);
    ...
    async run() {
        ...
        const actionTransformations = CmmaConfigurationActions_1.default.getArtifactTypeTransformationWithoutExtension({
            artifactType: 'action',
...
Action.commandName = 'cmma:make-action';
Action.description = 'Create a new CMMA Action';
Action.settings = {
    loadApp: false,
    stayAlive: false,
};
__decorate([
    standalone_1.args.string({ description: 'Name of the Action to be Created' }),
